...
export const CoveredCountriesSection = ({ articleContinents, countries }: Props) => {
        ...
        return (
            <Grid item xs={6} sm={4} md={3} key={c?.id}>
                ...
                <Typography variant='body1' sx={{
                    ...
                    <EastIcon fontSize='large' sx={{ color: theme.palette.secondary.main }} />
    ...
    return (
        ...
        <Stack sx={{ backgroundColor: "#000" }} id={'countries-we-cover'}>
            {/* <Stack sx={{ backgroundColor: theme.palette.primary.main }} id={'countries-we-cover'}> */}
